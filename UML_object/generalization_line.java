...
public class generalization_line extends line {
    ...
    public generalization_line(Point point1, Point point2, int arrow_width, int arrow_height) {
    ...
    public void draw(Graphics g) {
        ...
        // Draw the triangle(arrow head)
        Polygon arrow_head = new Polygon();
        arrow_head.addPoint(pointA_x, pointA_y);
        arrow_head.addPoint(pointB_x, pointB_y);
        arrow_head.addPoint(point2.x, point2.y);
        g.fillPolygon(arrow_head);
    }    
}
